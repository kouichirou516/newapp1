...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/release/uninstall.in \
	$(top_srcdir)/release/libjpeg.pc.in \
	$(top_srcdir)/release/libturbojpeg.pc.in \
	$(srcdir)/tjbenchtest.in $(srcdir)/tjbenchtest.java.in \
	$(srcdir)/tjexampletest.in $(srcdir)/libjpeg.map.in depcomp \
	$(dist_man1_MANS) $(dist_doc_DATA) $(dist_example_DATA) \
	$(am__include_HEADERS_DIST) ar-lib compile config.guess \
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/cjpeg-rdjpeg.Po@am__quote@
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/cjpeg-rdpng.Po@am__quote@
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/jcext.Plo@am__quote@
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/jpegyuv.Po@am__quote@
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/libturbojpeg_la-jcext.Plo@am__quote@
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/yuvjpeg.Po@am__quote@
